...
json = "{}"
# create an instance of QuotationItem from a JSON string
quotation_item_instance = QuotationItem.from_json(json)
# print the JSON string representation of the object
print(QuotationItem.to_json())

# convert the object into a dict
quotation_item_dict = quotation_item_instance.to_dict()
# create an instance of QuotationItem from a dict
quotation_item_from_dict = QuotationItem.from_dict(quotation_item_dict)
```
