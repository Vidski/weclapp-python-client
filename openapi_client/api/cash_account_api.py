...
class CashAccountApi:
    ...
    def cash_account_count_get(
        ...
        _param = self._cash_account_count_get_serialize(
    ...
    @validate_call
    def cash_account_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def cash_account_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _cash_account_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/cashAccount/count',
    ...
    def cash_account_get(
        ...
        _param = self._cash_account_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def cash_account_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CashAccountGet200Response]:
        """query cashAccount
    ...
    @validate_call
    def cash_account_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _cash_account_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
    ...
    def cash_account_id_id_get(
        ...
        _param = self._cash_account_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cash_account_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cash_account_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _cash_account_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/cashAccount/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def cash_account_id_id_put(
        ...
        :param id: (required)
        :type id: str
        :param cash_account: (required)
        :type cash_account: CashAccount
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._cash_account_id_id_put_serialize(
            id=id,
    ...
    @validate_call
    def cash_account_id_id_put_with_http_info(
        self,
        id: StrictStr,
        cash_account: CashAccount,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def cash_account_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        cash_account: CashAccount,
        dry_run: Optional[StrictBool] = None,
    ...
    def _cash_account_id_id_put_serialize(
        self,
        id,
        cash_account,
        dry_run,
    ...
    def cash_account_post(
        ...
        _param = self._cash_account_post_serialize(
            cash_account=cash_account,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def cash_account_post_with_http_info(
        self,
        cash_account: CashAccount,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def cash_account_post_without_preload_content(
        self,
        cash_account: CashAccount,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _cash_account_post_serialize(
        self,
        cash_account,
        dry_run,
        _request_auth,
