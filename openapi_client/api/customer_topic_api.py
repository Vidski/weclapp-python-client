...
class CustomerTopicApi:
    ...
    def customer_topic_count_get(
        ...
        _param = self._customer_topic_count_get_serialize(
    ...
    @validate_call
    def customer_topic_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def customer_topic_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _customer_topic_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/customerTopic/count',
    ...
    def customer_topic_get(
        ...
        _param = self._customer_topic_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def customer_topic_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    @validate_call
    def customer_topic_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _customer_topic_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
    ...
    @validate_call
    def customer_topic_id_id_delete(
        self,
        id: StrictStr,
        ...
        _param = self._customer_topic_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def customer_topic_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def customer_topic_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _customer_topic_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/customerTopic/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def customer_topic_id_id_get(
        ...
        _param = self._customer_topic_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def customer_topic_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def customer_topic_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _customer_topic_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def customer_topic_id_id_put(
        ...
        _param = self._customer_topic_id_id_put_serialize(
            id=id,
    ...
    @validate_call
    def customer_topic_id_id_put_with_http_info(
        self,
        id: StrictStr,
        custom_value: CustomValue,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def customer_topic_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        custom_value: CustomValue,
        dry_run: Optional[StrictBool] = None,
    ...
    def _customer_topic_id_id_put_serialize(
        self,
        id,
        custom_value,
        dry_run,
    ...
    def customer_topic_post(
        ...
        _param = self._customer_topic_post_serialize(
            custom_value=custom_value,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def customer_topic_post_with_http_info(
        self,
        custom_value: CustomValue,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def customer_topic_post_without_preload_content(
        self,
        custom_value: CustomValue,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _customer_topic_post_serialize(
        self,
        custom_value,
        dry_run,
        _request_auth,
