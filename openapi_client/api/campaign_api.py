...
class CampaignApi:
    ...
    def campaign_count_get(
        ...
        _param = self._campaign_count_get_serialize(
    ...
    @validate_call
    def campaign_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def campaign_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _campaign_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def campaign_id_id_delete(
        ...
        _param = self._campaign_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def campaign_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def campaign_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _campaign_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def campaign_id_id_get(
        ...
        _param = self._campaign_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def campaign_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def campaign_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _campaign_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def campaign_id_id_put(
        ...
        _param = self._campaign_id_id_put_serialize(
            id=id,
            campaign=campaign,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def campaign_id_id_put_with_http_info(
        self,
        id: StrictStr,
        campaign: Campaign,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def campaign_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        campaign: Campaign,
        dry_run: Optional[StrictBool] = None,
    ...
    def _campaign_id_id_put_serialize(
        self,
        id,
        campaign,
        dry_run,
