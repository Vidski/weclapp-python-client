...
class PaymentRunApi:
    ...
    def payment_run_count_get(
        ...
        _param = self._payment_run_count_get_serialize(
    ...
    @validate_call
    def payment_run_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def payment_run_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _payment_run_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/paymentRun/count',
    ...
    def payment_run_get(
        ...
        _param = self._payment_run_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def payment_run_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaymentRunGet200Response]:
        """query paymentRun
    ...
    @validate_call
    def payment_run_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _payment_run_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
    ...
    def payment_run_id_id_delete(
        ...
        _param = self._payment_run_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def payment_run_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def payment_run_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _payment_run_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/paymentRun/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def payment_run_id_id_get(
        ...
        _param = self._payment_run_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def payment_run_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def payment_run_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _payment_run_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def payment_run_id_id_put(
        ...
        :param id: (required)
        :type id: str
        :param payment_run: (required)
        :type payment_run: PaymentRun
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._payment_run_id_id_put_serialize(
            id=id,
    ...
    @validate_call
    def payment_run_id_id_put_with_http_info(
        self,
        id: StrictStr,
        payment_run: PaymentRun,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def payment_run_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        payment_run: PaymentRun,
        dry_run: Optional[StrictBool] = None,
    ...
    def _payment_run_id_id_put_serialize(
        self,
        id,
        payment_run,
        dry_run,
