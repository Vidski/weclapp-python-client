...
class ArchivedEmailApi:
    ...
    def archived_email_count_get(
        ...
        _param = self._archived_email_count_get_serialize(
            entity_id=entity_id,
    ...
    @validate_call
    def archived_email_count_get_with_http_info(
        self,
        entity_id: StrictStr,
        entity_name: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def archived_email_count_get_without_preload_content(
        self,
        entity_id: StrictStr,
        entity_name: StrictStr,
        _request_timeout: Union[
    ...
    def _archived_email_count_get_serialize(
        self,
        entity_id,
        entity_name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/archivedEmail/count',
    ...
    def archived_email_get(
        ...
        _param = self._archived_email_get_serialize(
            entity_id=entity_id,
            entity_name=entity_name,
            page=page,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ArchivedEmailGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def archived_email_get_with_http_info(
        self,
        entity_id: StrictStr,
        entity_name: StrictStr,
        page: Optional[StrictInt] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ArchivedEmailGet200Response]:
        """query archivedEmail
    ...
    @validate_call
    def archived_email_get_without_preload_content(
        self,
        entity_id: StrictStr,
        entity_name: StrictStr,
        page: Optional[StrictInt] = None,
    ...
    def _archived_email_get_serialize(
        self,
        entity_id,
        entity_name,
        page,
    ...
    def archived_email_id_id_get(
        ...
        _param = self._archived_email_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def archived_email_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def archived_email_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _archived_email_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/archivedEmail/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def archived_email_id_id_remove_reference_post(
        self,
        id: StrictStr,
        archived_email_id_id_remove_reference_post_request: ArchivedEmailIdIdRemoveReferencePostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: str
        :param archived_email_id_id_remove_reference_post_request: (required)
        :type archived_email_id_id_remove_reference_post_request: ArchivedEmailIdIdRemoveReferencePostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._archived_email_id_id_remove_reference_post_serialize(
            id=id,
            archived_email_id_id_remove_reference_post_request=archived_email_id_id_remove_reference_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def archived_email_id_id_remove_reference_post_with_http_info(
        self,
        id: StrictStr,
        archived_email_id_id_remove_reference_post_request: ArchivedEmailIdIdRemoveReferencePostRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def archived_email_id_id_remove_reference_post_without_preload_content(
        self,
        id: StrictStr,
        archived_email_id_id_remove_reference_post_request: ArchivedEmailIdIdRemoveReferencePostRequest,
        _request_timeout: Union[
    ...
    def _archived_email_id_id_remove_reference_post_serialize(
        self,
        id,
        archived_email_id_id_remove_reference_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if archived_email_id_id_remove_reference_post_request is not None:
            _body_params = archived_email_id_id_remove_reference_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/archivedEmail/id/{id}/removeReference',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
