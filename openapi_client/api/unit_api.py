...
class UnitApi:
    ...
    def unit_count_get(
        ...
        _param = self._unit_count_get_serialize(
    ...
    @validate_call
    def unit_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def unit_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def unit_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UnitGet200Response]:
        """query unit
    ...
    def unit_id_id_delete(
        ...
        _param = self._unit_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def unit_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def unit_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _unit_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def unit_id_id_get(
        ...
        _param = self._unit_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def unit_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def unit_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def unit_id_id_put(
        ...
        _param = self._unit_id_id_put_serialize(
            id=id,
            unit=unit,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def unit_id_id_put_with_http_info(
        self,
        id: StrictStr,
        unit: Unit,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def unit_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        unit: Unit,
        dry_run: Optional[StrictBool] = None,
    ...
    def unit_post(
        ...
        _param = self._unit_post_serialize(
            unit=unit,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def unit_post_without_preload_content(
        self,
        unit: Unit,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
