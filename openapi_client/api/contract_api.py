...
class ContractApi:
    ...
    def contract_count_get(
        ...
        _param = self._contract_count_get_serialize(
    ...
    @validate_call
    def contract_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def contract_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _contract_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def contract_get(
        ...
        _param = self._contract_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def contract_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContractGet200Response]:
        """query contract
    ...
    @validate_call
    def contract_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    @validate_call
    def contract_id_id_create_contract_document_post(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
        ...
        _param = self._contract_id_id_create_contract_document_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def contract_id_id_create_contract_document_post_with_http_info(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    @validate_call
    def contract_id_id_create_contract_document_post_without_preload_content(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    def _contract_id_id_create_contract_document_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/contract/id/{id}/createContractDocument',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def contract_id_id_delete(
        ...
        _param = self._contract_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def contract_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def contract_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _contract_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    @validate_call
    def contract_id_id_download_latest_contract_document_pdf_get(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._contract_id_id_download_latest_contract_document_pdf_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def contract_id_id_download_latest_contract_document_pdf_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def contract_id_id_download_latest_contract_document_pdf_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _contract_id_id_download_latest_contract_document_pdf_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/contract/id/{id}/downloadLatestContractDocumentPdf',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def contract_id_id_get(
        ...
        _param = self._contract_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def contract_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def contract_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _contract_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def contract_id_id_put(
        ...
        _param = self._contract_id_id_put_serialize(
            id=id,
            contract=contract,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def contract_id_id_put_with_http_info(
        self,
        id: StrictStr,
        contract: Contract,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def contract_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        contract: Contract,
        dry_run: Optional[StrictBool] = None,
    ...
    def _contract_id_id_put_serialize(
        self,
        id,
        contract,
        dry_run,
    ...
    def contract_post(
        ...
        _param = self._contract_post_serialize(
            contract=contract,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def contract_post_with_http_info(
        self,
        contract: Contract,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def contract_post_without_preload_content(
        self,
        contract: Contract,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
