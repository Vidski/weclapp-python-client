...
class UserApi:
    ...
    def user_count_get(
        ...
        _param = self._user_count_get_serialize(
    ...
    @validate_call
    def user_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def user_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def user_current_user_get(
        ...
        _param = self._user_current_user_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UserCurrentUserGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def user_current_user_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserCurrentUserGet200Response]:
        """user_current_user_get
    ...
    @validate_call
    def user_current_user_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _user_current_user_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/user/currentUser',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def user_id_id_delete(
        ...
        _param = self._user_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def user_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def user_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _user_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def user_id_id_get(
        ...
        _param = self._user_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def user_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def user_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def user_id_id_invite_post(
        ...
        _param = self._user_id_id_invite_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def user_id_id_invite_post_with_http_info(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    @validate_call
    def user_id_id_invite_post_without_preload_content(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    def _user_id_id_invite_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/user/id/{id}/invite',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def user_id_id_put(
        ...
        _param = self._user_id_id_put_serialize(
            id=id,
            user=user,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def user_id_id_put_with_http_info(
        self,
        id: StrictStr,
        user: User,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def user_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        user: User,
        dry_run: Optional[StrictBool] = None,
    ...
    def user_id_id_user_image_get(
        ...
        _param = self._user_id_id_user_image_get_serialize(
            id=id,
    ...
    @validate_call
    def user_id_id_user_image_get_with_http_info(
        self,
        id: StrictStr,
        scale_width: Optional[StrictInt] = None,
        scale_height: Optional[StrictInt] = None,
    ...
    @validate_call
    def user_id_id_user_image_get_without_preload_content(
        self,
        id: StrictStr,
        scale_width: Optional[StrictInt] = None,
        scale_height: Optional[StrictInt] = None,
    ...
    def _user_id_id_user_image_get_serialize(
        self,
        id,
        scale_width,
        scale_height,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/user/id/{id}/userImage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def user_id_id_user_image_thumbnail_get(
        self,
        id: StrictStr,
        scale_width: Optional[StrictInt] = None,
        scale_height: Optional[StrictInt] = None,
        ...
        _param = self._user_id_id_user_image_thumbnail_get_serialize(
            id=id,
            scale_width=scale_width,
            scale_height=scale_height,
            image_id=image_id,
    ...
    @validate_call
    def user_id_id_user_image_thumbnail_get_with_http_info(
        self,
        id: StrictStr,
        scale_width: Optional[StrictInt] = None,
        scale_height: Optional[StrictInt] = None,
    ...
    @validate_call
    def user_id_id_user_image_thumbnail_get_without_preload_content(
        self,
        id: StrictStr,
        scale_width: Optional[StrictInt] = None,
        scale_height: Optional[StrictInt] = None,
    ...
    def _user_id_id_user_image_thumbnail_get_serialize(
        self,
        id,
        scale_width,
        scale_height,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/user/id/{id}/userImageThumbnail',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
