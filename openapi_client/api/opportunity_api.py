...
class OpportunityApi:
    ...
    def opportunity_count_get(
        ...
        _param = self._opportunity_count_get_serialize(
    ...
    @validate_call
    def opportunity_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def opportunity_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _opportunity_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/opportunity/count',
    ...
    def opportunity_get(
        ...
        _param = self._opportunity_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def opportunity_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OpportunityGet200Response]:
        """query opportunity
    ...
    @validate_call
    def opportunity_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _opportunity_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
    ...
    def opportunity_id_id_delete(
        ...
        _param = self._opportunity_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def opportunity_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def opportunity_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _opportunity_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/opportunity/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def opportunity_id_id_get(
        ...
        _param = self._opportunity_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def opportunity_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def opportunity_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _opportunity_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def opportunity_id_id_link_quotation_post(
        self,
        id: StrictStr,
        opportunity_id_id_link_quotation_post_request: OpportunityIdIdLinkQuotationPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: str
        :param opportunity_id_id_link_quotation_post_request: (required)
        :type opportunity_id_id_link_quotation_post_request: OpportunityIdIdLinkQuotationPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._opportunity_id_id_link_quotation_post_serialize(
            id=id,
            opportunity_id_id_link_quotation_post_request=opportunity_id_id_link_quotation_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OpportunityIdIdLinkQuotationPost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def opportunity_id_id_link_quotation_post_with_http_info(
        self,
        id: StrictStr,
        opportunity_id_id_link_quotation_post_request: OpportunityIdIdLinkQuotationPostRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OpportunityIdIdLinkQuotationPost200Response]:
        """opportunity_id_id_link_quotation_post
    ...
    @validate_call
    def opportunity_id_id_link_quotation_post_without_preload_content(
        self,
        id: StrictStr,
        opportunity_id_id_link_quotation_post_request: OpportunityIdIdLinkQuotationPostRequest,
        _request_timeout: Union[
    ...
    def _opportunity_id_id_link_quotation_post_serialize(
        self,
        id,
        opportunity_id_id_link_quotation_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if opportunity_id_id_link_quotation_post_request is not None:
            _body_params = opportunity_id_id_link_quotation_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/opportunity/id/{id}/linkQuotation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def opportunity_id_id_put(
        ...
        _param = self._opportunity_id_id_put_serialize(
            id=id,
            opportunity=opportunity,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def opportunity_id_id_put_with_http_info(
        self,
        id: StrictStr,
        opportunity: Opportunity,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def opportunity_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        opportunity: Opportunity,
        dry_run: Optional[StrictBool] = None,
    ...
    def _opportunity_id_id_put_serialize(
        self,
        id,
        opportunity,
        dry_run,
    ...
    def opportunity_post(
        ...
        _param = self._opportunity_post_serialize(
            opportunity=opportunity,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def opportunity_post_with_http_info(
        self,
        opportunity: Opportunity,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def opportunity_post_without_preload_content(
        self,
        opportunity: Opportunity,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _opportunity_post_serialize(
        self,
        opportunity,
        dry_run,
        _request_auth,
