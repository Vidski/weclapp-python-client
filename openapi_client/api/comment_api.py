...
class CommentApi:
    ...
    def comment_count_get(
        ...
        _param = self._comment_count_get_serialize(
            entity_id=entity_id,
    ...
    @validate_call
    def comment_count_get_with_http_info(
        self,
        entity_id: StrictStr,
        entity_name: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def comment_count_get_without_preload_content(
        self,
        entity_id: StrictStr,
        entity_name: StrictStr,
        _request_timeout: Union[
    ...
    def _comment_count_get_serialize(
        self,
        entity_id,
        entity_name,
        _request_auth,
    ...
    def comment_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CommentGet200Response]:
        """query comment
    ...
    def comment_id_id_delete(
        ...
        _param = self._comment_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def comment_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def comment_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _comment_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def comment_id_id_get(
        ...
        _param = self._comment_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def comment_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def comment_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _comment_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def comment_id_id_put(
        ...
        _param = self._comment_id_id_put_serialize(
            id=id,
            comment=comment,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def comment_id_id_put_with_http_info(
        self,
        id: StrictStr,
        comment: Comment,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def comment_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        comment: Comment,
        dry_run: Optional[StrictBool] = None,
    ...
    def _comment_id_id_put_serialize(
        self,
        id,
        comment,
        dry_run,
