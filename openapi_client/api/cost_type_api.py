...
class CostTypeApi:
    ...
    def cost_type_count_get(
        ...
        _param = self._cost_type_count_get_serialize(
    ...
    @validate_call
    def cost_type_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def cost_type_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _cost_type_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def cost_type_get(
        ...
        _param = self._cost_type_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def cost_type_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CostTypeGet200Response]:
        """query costType
    ...
    @validate_call
    def cost_type_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def cost_type_id_id_delete(
        ...
        _param = self._cost_type_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def cost_type_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def cost_type_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _cost_type_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def cost_type_id_id_get(
        ...
        _param = self._cost_type_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cost_type_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cost_type_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _cost_type_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def cost_type_id_id_put(
        ...
        _param = self._cost_type_id_id_put_serialize(
            id=id,
            cost_type=cost_type,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def cost_type_id_id_put_with_http_info(
        self,
        id: StrictStr,
        cost_type: CostType,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def cost_type_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        cost_type: CostType,
        dry_run: Optional[StrictBool] = None,
    ...
    def _cost_type_id_id_put_serialize(
        self,
        id,
        cost_type,
        dry_run,
    ...
    def cost_type_post(
        ...
        _param = self._cost_type_post_serialize(
            cost_type=cost_type,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def cost_type_post_with_http_info(
        self,
        cost_type: CostType,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def cost_type_post_without_preload_content(
        self,
        cost_type: CostType,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
