...
class CalendarEventApi:
    ...
    def calendar_event_count_get(
        ...
        _param = self._calendar_event_count_get_serialize(
    ...
    @validate_call
    def calendar_event_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def calendar_event_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _calendar_event_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/calendarEvent/count',
    ...
    def calendar_event_get(
        ...
        _param = self._calendar_event_get_serialize(
            page=page,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CalendarEventGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def calendar_event_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CalendarEventGet200Response]:
        """query calendarEvent
    ...
    @validate_call
    def calendar_event_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _calendar_event_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
    ...
    @validate_call
    def calendar_event_id_id_delete(
        self,
        id: StrictStr,
        ...
        _param = self._calendar_event_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def calendar_event_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def calendar_event_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _calendar_event_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/calendarEvent/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def calendar_event_id_id_get(
        ...
        _param = self._calendar_event_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def calendar_event_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def calendar_event_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _calendar_event_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def calendar_event_id_id_put(
        ...
        _param = self._calendar_event_id_id_put_serialize(
            id=id,
    ...
    @validate_call
    def calendar_event_id_id_put_with_http_info(
        self,
        id: StrictStr,
        calendar_event: CalendarEvent,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def calendar_event_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        calendar_event: CalendarEvent,
        dry_run: Optional[StrictBool] = None,
    ...
    def _calendar_event_id_id_put_serialize(
        self,
        id,
        calendar_event,
        dry_run,
    ...
    def calendar_event_post(
        ...
        _param = self._calendar_event_post_serialize(
            calendar_event=calendar_event,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def calendar_event_post_with_http_info(
        self,
        calendar_event: CalendarEvent,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def calendar_event_post_without_preload_content(
        self,
        calendar_event: CalendarEvent,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _calendar_event_post_serialize(
        self,
        calendar_event,
        dry_run,
        _request_auth,
