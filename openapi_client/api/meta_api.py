...
class MetaApi:
    ...
    @validate_call
    def meta_query_filter_properties_get(
        self,
        resource: StrictStr,
        ...
        _param = self._meta_query_filter_properties_get_serialize(
            resource=resource,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MetaQueryFilterPropertiesGet200Response",
        }
    ...
    @validate_call
    def meta_query_filter_properties_get_with_http_info(
        self,
        resource: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MetaQueryFilterPropertiesGet200Response]:
        """meta_query_filter_properties_get
    ...
    @validate_call
    def meta_query_filter_properties_get_without_preload_content(
        self,
        resource: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _meta_query_filter_properties_get_serialize(
        self,
        resource,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/meta/queryFilterProperties',
    ...
    @validate_call
    def meta_query_sort_properties_get(
        self,
        resource: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._meta_query_sort_properties_get_serialize(
            resource=resource,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def meta_query_sort_properties_get_with_http_info(
        self,
        resource: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def meta_query_sort_properties_get_without_preload_content(
        self,
        resource: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _meta_query_sort_properties_get_serialize(
        self,
        resource,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/meta/querySortProperties',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def meta_resources_get(
        ...
        _param = self._meta_resources_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MetaResourcesGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def meta_resources_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MetaResourcesGet200Response]:
        """meta_resources_get
    ...
    @validate_call
    def meta_resources_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _meta_resources_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
