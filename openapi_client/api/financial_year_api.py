...
class FinancialYearApi:
    ...
    def financial_year_count_get(
        ...
        _param = self._financial_year_count_get_serialize(
    ...
    @validate_call
    def financial_year_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def financial_year_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _financial_year_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/financialYear/count',
    ...
    def financial_year_get(
        ...
        _param = self._financial_year_get_serialize(
            page=page,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FinancialYearGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def financial_year_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FinancialYearGet200Response]:
        """query financialYear
    ...
    @validate_call
    def financial_year_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _financial_year_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
    ...
    @validate_call
    def financial_year_id_id_delete(
        self,
        id: StrictStr,
        ...
        _param = self._financial_year_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def financial_year_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def financial_year_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _financial_year_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/financialYear/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def financial_year_id_id_generate_periods_post(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
        ...
        _param = self._financial_year_id_id_generate_periods_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FinancialYearIdIdGeneratePeriodsPost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def financial_year_id_id_generate_periods_post_with_http_info(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FinancialYearIdIdGeneratePeriodsPost200Response]:
        """financial_year_id_id_generate_periods_post
    ...
    @validate_call
    def financial_year_id_id_generate_periods_post_without_preload_content(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    def _financial_year_id_id_generate_periods_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/financialYear/id/{id}/generatePeriods',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def financial_year_id_id_get(
        ...
        _param = self._financial_year_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def financial_year_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def financial_year_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _financial_year_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def financial_year_id_id_put(
        ...
        :param id: (required)
        :type id: str
        :param financial_year: (required)
        :type financial_year: FinancialYear
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._financial_year_id_id_put_serialize(
            id=id,
    ...
    @validate_call
    def financial_year_id_id_put_with_http_info(
        self,
        id: StrictStr,
        financial_year: FinancialYear,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def financial_year_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        financial_year: FinancialYear,
        dry_run: Optional[StrictBool] = None,
    ...
    def _financial_year_id_id_put_serialize(
        self,
        id,
        financial_year,
        dry_run,
    ...
    def financial_year_post(
        ...
        _param = self._financial_year_post_serialize(
            financial_year=financial_year,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def financial_year_post_with_http_info(
        self,
        financial_year: FinancialYear,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def financial_year_post_without_preload_content(
        self,
        financial_year: FinancialYear,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _financial_year_post_serialize(
        self,
        financial_year,
        dry_run,
        _request_auth,
