...
class TicketApi:
    ...
    def ticket_count_get(
        ...
        _param = self._ticket_count_get_serialize(
    ...
    @validate_call
    def ticket_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def ticket_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _ticket_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def ticket_get(
        ...
        _param = self._ticket_get_serialize(
            page=page,
            page_size=page_size,
    ...
    def ticket_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TicketGet200Response]:
        """query ticket
    ...
    @validate_call
    def ticket_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    @validate_call
    def ticket_id_id_create_public_page_post(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
        ...
        _param = self._ticket_id_id_create_public_page_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TicketIdIdCreatePublicPagePost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def ticket_id_id_create_public_page_post_with_http_info(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TicketIdIdCreatePublicPagePost200Response]:
        """ticket_id_id_create_public_page_post
    ...
    @validate_call
    def ticket_id_id_create_public_page_post_without_preload_content(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    def _ticket_id_id_create_public_page_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/ticket/id/{id}/createPublicPage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def ticket_id_id_delete(
        ...
        _param = self._ticket_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def ticket_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def ticket_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _ticket_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    @validate_call
    def ticket_id_id_disable_public_page_post(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
        ...
        _param = self._ticket_id_id_disable_public_page_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def ticket_id_id_disable_public_page_post_with_http_info(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    @validate_call
    def ticket_id_id_disable_public_page_post_without_preload_content(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    def _ticket_id_id_disable_public_page_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/ticket/id/{id}/disablePublicPage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def ticket_id_id_get(
        ...
        _param = self._ticket_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def ticket_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def ticket_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _ticket_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def ticket_id_id_link_sales_order_post(
        self,
        id: StrictStr,
        ticket_id_id_link_sales_order_post_request: TicketIdIdLinkSalesOrderPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: str
        :param ticket_id_id_link_sales_order_post_request: (required)
        :type ticket_id_id_link_sales_order_post_request: TicketIdIdLinkSalesOrderPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._ticket_id_id_link_sales_order_post_serialize(
            id=id,
            ticket_id_id_link_sales_order_post_request=ticket_id_id_link_sales_order_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def ticket_id_id_link_sales_order_post_with_http_info(
        self,
        id: StrictStr,
        ticket_id_id_link_sales_order_post_request: TicketIdIdLinkSalesOrderPostRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def ticket_id_id_link_sales_order_post_without_preload_content(
        self,
        id: StrictStr,
        ticket_id_id_link_sales_order_post_request: TicketIdIdLinkSalesOrderPostRequest,
        _request_timeout: Union[
    ...
    def _ticket_id_id_link_sales_order_post_serialize(
        self,
        id,
        ticket_id_id_link_sales_order_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if ticket_id_id_link_sales_order_post_request is not None:
            _body_params = ticket_id_id_link_sales_order_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/ticket/id/{id}/linkSalesOrder',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def ticket_id_id_put(
        ...
        _param = self._ticket_id_id_put_serialize(
            id=id,
            ticket=ticket,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def ticket_id_id_put_with_http_info(
        self,
        id: StrictStr,
        ticket: Ticket,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def ticket_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        ticket: Ticket,
        dry_run: Optional[StrictBool] = None,
    ...
    def _ticket_id_id_put_serialize(
        self,
        id,
        ticket,
        dry_run,
    ...
    @validate_call
    def ticket_id_id_unlink_sales_order_post(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
        ...
        _param = self._ticket_id_id_unlink_sales_order_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def ticket_id_id_unlink_sales_order_post_with_http_info(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    @validate_call
    def ticket_id_id_unlink_sales_order_post_without_preload_content(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    def _ticket_id_id_unlink_sales_order_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/ticket/id/{id}/unlinkSalesOrder',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
