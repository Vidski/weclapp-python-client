...
class WeclappOsApi:
    ...
    def weclapp_os_count_get(
        ...
        _param = self._weclapp_os_count_get_serialize(
    ...
    @validate_call
    def weclapp_os_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def weclapp_os_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _weclapp_os_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def weclapp_os_get(
        ...
        _param = self._weclapp_os_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def weclapp_os_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WeclappOsGet200Response]:
        """query weclappOs
    ...
    @validate_call
    def weclapp_os_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def weclapp_os_id_id_delete(
        ...
        _param = self._weclapp_os_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def weclapp_os_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def weclapp_os_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _weclapp_os_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def weclapp_os_id_id_get(
        ...
        _param = self._weclapp_os_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def weclapp_os_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def weclapp_os_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _weclapp_os_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def weclapp_os_id_id_put(
        ...
        :param id: (required)
        :type id: str
        :param weclapp_os: (required)
        :type weclapp_os: WeclappOs
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._weclapp_os_id_id_put_serialize(
            id=id,
            weclapp_os=weclapp_os,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def weclapp_os_id_id_put_with_http_info(
        self,
        id: StrictStr,
        weclapp_os: WeclappOs,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def weclapp_os_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        weclapp_os: WeclappOs,
        dry_run: Optional[StrictBool] = None,
    ...
    def _weclapp_os_id_id_put_serialize(
        self,
        id,
        weclapp_os,
        dry_run,
        ...
        # process the form parameters
        # process the body parameter
        if weclapp_os is not None:
            _body_params = weclapp_os
    ...
    def weclapp_os_post(
        ...
        _param = self._weclapp_os_post_serialize(
            weclapp_os=weclapp_os,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def weclapp_os_post_with_http_info(
        self,
        weclapp_os: WeclappOs,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def weclapp_os_post_without_preload_content(
        self,
        weclapp_os: WeclappOs,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _weclapp_os_post_serialize(
        self,
        weclapp_os,
        dry_run,
        _request_auth,
