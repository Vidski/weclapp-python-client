...
class BankAccountApi:
    ...
    def bank_account_count_get(
        ...
        _param = self._bank_account_count_get_serialize(
    ...
    @validate_call
    def bank_account_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def bank_account_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _bank_account_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/bankAccount/count',
    ...
    def bank_account_get(
        ...
        _param = self._bank_account_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def bank_account_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountGet200Response]:
        """query bankAccount
    ...
    @validate_call
    def bank_account_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _bank_account_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
    ...
    def bank_account_id_id_delete(
        ...
        _param = self._bank_account_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def bank_account_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def bank_account_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _bank_account_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/bankAccount/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def bank_account_id_id_get(
        ...
        _param = self._bank_account_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def bank_account_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bank_account_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _bank_account_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def bank_account_id_id_put(
        ...
        _param = self._bank_account_id_id_put_serialize(
            id=id,
    ...
    @validate_call
    def bank_account_id_id_put_with_http_info(
        self,
        id: StrictStr,
        bank_account: BankAccount,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def bank_account_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        bank_account: BankAccount,
        dry_run: Optional[StrictBool] = None,
    ...
    def _bank_account_id_id_put_serialize(
        self,
        id,
        bank_account,
        dry_run,
    ...
    def bank_account_post(
        ...
        _param = self._bank_account_post_serialize(
            bank_account=bank_account,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def bank_account_post_with_http_info(
        self,
        bank_account: BankAccount,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def bank_account_post_without_preload_content(
        self,
        bank_account: BankAccount,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _bank_account_post_serialize(
        self,
        bank_account,
        dry_run,
        _request_auth,
