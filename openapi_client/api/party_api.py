...
class PartyApi:
    ...
    def party_count_get(
        ...
        _param = self._party_count_get_serialize(
    ...
    @validate_call
    def party_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def party_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _party_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def party_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PartyGet200Response]:
        """query party
    ...
    def party_id_id_delete(
        ...
        _param = self._party_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def party_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def party_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _party_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    @validate_call
    def party_id_id_download_image_get(
        self,
        id: StrictStr,
        ...
        _param = self._party_id_id_download_image_get_serialize(
            id=id,
    ...
    @validate_call
    def party_id_id_download_image_get_with_http_info(
        self,
        id: StrictStr,
        scale_width: Optional[StrictInt] = None,
        scale_height: Optional[StrictInt] = None,
    ...
    @validate_call
    def party_id_id_download_image_get_without_preload_content(
        self,
        id: StrictStr,
        scale_width: Optional[StrictInt] = None,
        scale_height: Optional[StrictInt] = None,
    ...
    def _party_id_id_download_image_get_serialize(
        self,
        id,
        scale_width,
        scale_height,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/party/id/{id}/downloadImage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def party_id_id_get(
        ...
        _param = self._party_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def party_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def party_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _party_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def party_id_id_put(
        ...
        _param = self._party_id_id_put_serialize(
            id=id,
            party=party,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def party_id_id_put_with_http_info(
        self,
        id: StrictStr,
        party: Party,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def party_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        party: Party,
        dry_run: Optional[StrictBool] = None,
    ...
    def _party_id_id_put_serialize(
        self,
        id,
        party,
        dry_run,
    ...
    @validate_call
    def party_id_id_upload_image_post(
        self,
        id: StrictStr,
        ...
        _param = self._party_id_id_upload_image_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def party_id_id_upload_image_post_with_http_info(
        self,
        id: StrictStr,
        body: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        _request_timeout: Union[
    ...
    @validate_call
    def party_id_id_upload_image_post_without_preload_content(
        self,
        id: StrictStr,
        body: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        _request_timeout: Union[
    ...
    def _party_id_id_upload_image_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/party/id/{id}/uploadImage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def party_post(
        ...
        _param = self._party_post_serialize(
            party=party,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def party_post_without_preload_content(
        self,
        party: Party,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
