...
class ShipmentReturnRectificationApi:
    ...
    @validate_call
    def shipment_return_rectification_count_get(
        self,
        ...
        _param = self._shipment_return_rectification_count_get_serialize(
    ...
    @validate_call
    def shipment_return_rectification_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def shipment_return_rectification_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _shipment_return_rectification_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/shipmentReturnRectification/count',
    ...
    @validate_call
    def shipment_return_rectification_get(
        self,
        ...
        _param = self._shipment_return_rectification_get_serialize(
            page=page,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ShipmentReturnAssessmentGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def shipment_return_rectification_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShipmentReturnAssessmentGet200Response]:
        """query shipmentReturnRectification
    ...
    @validate_call
    def shipment_return_rectification_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _shipment_return_rectification_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/shipmentReturnRectification',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def shipment_return_rectification_id_id_delete(
        self,
        id: StrictStr,
        ...
        _param = self._shipment_return_rectification_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def shipment_return_rectification_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def shipment_return_rectification_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _shipment_return_rectification_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/shipmentReturnRectification/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def shipment_return_rectification_id_id_get(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._shipment_return_rectification_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def shipment_return_rectification_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShipmentReturnDescription]:
        """query a specific shipmentReturnRectification
    ...
    @validate_call
    def shipment_return_rectification_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _shipment_return_rectification_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def shipment_return_rectification_id_id_put(
        self,
        id: StrictStr,
        shipment_return_description: ShipmentReturnDescription,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param id: (required)
        :type id: str
        :param shipment_return_description: (required)
        :type shipment_return_description: ShipmentReturnDescription
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._shipment_return_rectification_id_id_put_serialize(
            id=id,
            shipment_return_description=shipment_return_description,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def shipment_return_rectification_id_id_put_with_http_info(
        self,
        id: StrictStr,
        shipment_return_description: ShipmentReturnDescription,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def shipment_return_rectification_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        shipment_return_description: ShipmentReturnDescription,
        dry_run: Optional[StrictBool] = None,
    ...
    def _shipment_return_rectification_id_id_put_serialize(
        self,
        id,
        shipment_return_description,
        dry_run,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if shipment_return_description is not None:
            _body_params = shipment_return_description
    ...
    @validate_call
    def shipment_return_rectification_post(
        self,
        shipment_return_description: ShipmentReturnDescription,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
        ...
        _param = self._shipment_return_rectification_post_serialize(
            shipment_return_description=shipment_return_description,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def shipment_return_rectification_post_with_http_info(
        self,
        shipment_return_description: ShipmentReturnDescription,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def shipment_return_rectification_post_without_preload_content(
        self,
        shipment_return_description: ShipmentReturnDescription,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _shipment_return_rectification_post_serialize(
        self,
        shipment_return_description,
        dry_run,
        _request_auth,
