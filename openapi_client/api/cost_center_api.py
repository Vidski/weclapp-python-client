...
class CostCenterApi:
    ...
    def cost_center_count_get(
        ...
        _param = self._cost_center_count_get_serialize(
    ...
    @validate_call
    def cost_center_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def cost_center_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _cost_center_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/costCenter/count',
    ...
    def cost_center_get(
        ...
        _param = self._cost_center_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def cost_center_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CostCenterGet200Response]:
        """query costCenter
    ...
    @validate_call
    def cost_center_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _cost_center_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
    ...
    def cost_center_id_id_delete(
        ...
        _param = self._cost_center_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def cost_center_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def cost_center_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _cost_center_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/costCenter/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def cost_center_id_id_get(
        ...
        _param = self._cost_center_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cost_center_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cost_center_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _cost_center_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def cost_center_id_id_put(
        ...
        :param id: (required)
        :type id: str
        :param cost_center: (required)
        :type cost_center: CostCenter
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._cost_center_id_id_put_serialize(
            id=id,
    ...
    @validate_call
    def cost_center_id_id_put_with_http_info(
        self,
        id: StrictStr,
        cost_center: CostCenter,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def cost_center_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        cost_center: CostCenter,
        dry_run: Optional[StrictBool] = None,
    ...
    def _cost_center_id_id_put_serialize(
        self,
        id,
        cost_center,
        dry_run,
    ...
    def cost_center_post(
        ...
        _param = self._cost_center_post_serialize(
            cost_center=cost_center,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def cost_center_post_with_http_info(
        self,
        cost_center: CostCenter,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def cost_center_post_without_preload_content(
        self,
        cost_center: CostCenter,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _cost_center_post_serialize(
        self,
        cost_center,
        dry_run,
        _request_auth,
