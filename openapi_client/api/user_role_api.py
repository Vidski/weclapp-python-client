...
class UserRoleApi:
    ...
    def user_role_count_get(
        ...
        _param = self._user_role_count_get_serialize(
    ...
    @validate_call
    def user_role_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def user_role_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _user_role_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def user_role_disable_user_roles_during_trial_post(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
        ...
        _param = self._user_role_disable_user_roles_during_trial_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def user_role_disable_user_roles_during_trial_post_with_http_info(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def user_role_disable_user_roles_during_trial_post_without_preload_content(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    def _user_role_disable_user_roles_during_trial_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/userRole/disableUserRolesDuringTrial',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def user_role_enable_user_roles_during_trial_post(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
        ...
        _param = self._user_role_enable_user_roles_during_trial_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def user_role_enable_user_roles_during_trial_post_with_http_info(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def user_role_enable_user_roles_during_trial_post_without_preload_content(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    def _user_role_enable_user_roles_during_trial_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/userRole/enableUserRolesDuringTrial',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def user_role_get(
        ...
        _param = self._user_role_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def user_role_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserRoleGet200Response]:
        """query userRole
    ...
    @validate_call
    def user_role_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def user_role_id_id_delete(
        ...
        _param = self._user_role_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def user_role_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def user_role_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _user_role_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def user_role_id_id_get(
        ...
        _param = self._user_role_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def user_role_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def user_role_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _user_role_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def user_role_id_id_put(
        ...
        _param = self._user_role_id_id_put_serialize(
            id=id,
            user_role=user_role,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def user_role_id_id_put_with_http_info(
        self,
        id: StrictStr,
        user_role: UserRole,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def user_role_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        user_role: UserRole,
        dry_run: Optional[StrictBool] = None,
    ...
    def _user_role_id_id_put_serialize(
        self,
        id,
        user_role,
        dry_run,
    ...
    def user_role_post(
        ...
        _param = self._user_role_post_serialize(
            user_role=user_role,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def user_role_post_with_http_info(
        self,
        user_role: UserRole,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def user_role_post_without_preload_content(
        self,
        user_role: UserRole,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
