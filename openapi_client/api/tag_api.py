...
class TagApi:
    ...
    def tag_count_get(
        ...
        _param = self._tag_count_get_serialize(
    ...
    @validate_call
    def tag_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def tag_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def tag_id_id_delete(
        ...
        _param = self._tag_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def tag_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def tag_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _tag_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def tag_id_id_get(
        ...
        _param = self._tag_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def tag_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def tag_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def tag_id_id_put(
        ...
        _param = self._tag_id_id_put_serialize(
            id=id,
            tag=tag,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def tag_id_id_put_with_http_info(
        self,
        id: StrictStr,
        tag: Tag,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def tag_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        tag: Tag,
        dry_run: Optional[StrictBool] = None,
