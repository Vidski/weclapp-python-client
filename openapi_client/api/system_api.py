...
class SystemApi:
    ...
    @validate_call
    def system_create_demo_test_system_post(
        self,
        system_create_demo_test_system_post_request: SystemCreateDemoTestSystemPostRequest,
        ...
        :param system_create_demo_test_system_post_request: (required)
        :type system_create_demo_test_system_post_request: SystemCreateDemoTestSystemPostRequest
        ...
        _param = self._system_create_demo_test_system_post_serialize(
            system_create_demo_test_system_post_request=system_create_demo_test_system_post_request,
    ...
    @validate_call
    def system_create_demo_test_system_post_with_http_info(
        self,
        system_create_demo_test_system_post_request: SystemCreateDemoTestSystemPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def system_create_demo_test_system_post_without_preload_content(
        self,
        system_create_demo_test_system_post_request: SystemCreateDemoTestSystemPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _system_create_demo_test_system_post_serialize(
        self,
        system_create_demo_test_system_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if system_create_demo_test_system_post_request is not None:
            _body_params = system_create_demo_test_system_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/system/createDemoTestSystem',
    ...
    @validate_call
    def system_demo_test_system_info_get(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._system_demo_test_system_info_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SystemDemoTestSystemInfoGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def system_demo_test_system_info_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SystemDemoTestSystemInfoGet200Response]:
        """system_demo_test_system_info_get
    ...
    @validate_call
    def system_demo_test_system_info_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _system_demo_test_system_info_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/demoTestSystemInfo',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def system_licenses_get(
        ...
        _param = self._system_licenses_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SystemLicensesGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def system_licenses_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SystemLicensesGet200Response]:
        """system_licenses_get
    ...
    @validate_call
    def system_licenses_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _system_licenses_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
