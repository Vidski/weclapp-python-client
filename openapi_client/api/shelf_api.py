...
class ShelfApi:
    ...
    def shelf_count_get(
        ...
        _param = self._shelf_count_get_serialize(
    ...
    @validate_call
    def shelf_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def shelf_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _shelf_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def shelf_get(
        ...
        _param = self._shelf_get_serialize(
            page=page,
            page_size=page_size,
    ...
    def shelf_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShelfGet200Response]:
        """query shelf
    ...
    @validate_call
    def shelf_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def shelf_id_id_activate_post(
        ...
        _param = self._shelf_id_id_activate_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ShelfIdIdActivatePost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def shelf_id_id_activate_post_with_http_info(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShelfIdIdActivatePost200Response]:
        """shelf_id_id_activate_post
    ...
    @validate_call
    def shelf_id_id_activate_post_without_preload_content(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    def _shelf_id_id_activate_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/shelf/id/{id}/activate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def shelf_id_id_deactivate_post(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
        ...
        _param = self._shelf_id_id_deactivate_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def shelf_id_id_deactivate_post_with_http_info(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    @validate_call
    def shelf_id_id_deactivate_post_without_preload_content(
        self,
        id: StrictStr,
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    def _shelf_id_id_deactivate_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/shelf/id/{id}/deactivate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def shelf_id_id_delete(
        ...
        _param = self._shelf_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def shelf_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def shelf_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _shelf_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def shelf_id_id_get(
        ...
        _param = self._shelf_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def shelf_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def shelf_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _shelf_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def shelf_id_id_put(
        ...
        _param = self._shelf_id_id_put_serialize(
            id=id,
            shelf=shelf,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def shelf_id_id_put_with_http_info(
        self,
        id: StrictStr,
        shelf: Shelf,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def shelf_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        shelf: Shelf,
        dry_run: Optional[StrictBool] = None,
    ...
    def _shelf_id_id_put_serialize(
        self,
        id,
        shelf,
        dry_run,
    ...
    def shelf_post(
        ...
        _param = self._shelf_post_serialize(
            shelf=shelf,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def shelf_post_without_preload_content(
        self,
        shelf: Shelf,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
