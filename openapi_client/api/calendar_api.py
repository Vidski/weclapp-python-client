...
class CalendarApi:
    ...
    def calendar_count_get(
        ...
        _param = self._calendar_count_get_serialize(
    ...
    @validate_call
    def calendar_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def calendar_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _calendar_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def calendar_get(
        ...
        _param = self._calendar_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def calendar_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CalendarGet200Response]:
        """query calendar
    ...
    @validate_call
    def calendar_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def calendar_id_id_delete(
        ...
        _param = self._calendar_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def calendar_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def calendar_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _calendar_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    @validate_call
    def calendar_id_id_delete_calendar_and_move_events_post(
        self,
        id: StrictStr,
        calendar_id_id_delete_calendar_and_move_events_post_request: CalendarIdIdDeleteCalendarAndMoveEventsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: str
        :param calendar_id_id_delete_calendar_and_move_events_post_request: (required)
        :type calendar_id_id_delete_calendar_and_move_events_post_request: CalendarIdIdDeleteCalendarAndMoveEventsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._calendar_id_id_delete_calendar_and_move_events_post_serialize(
            id=id,
            calendar_id_id_delete_calendar_and_move_events_post_request=calendar_id_id_delete_calendar_and_move_events_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def calendar_id_id_delete_calendar_and_move_events_post_with_http_info(
        self,
        id: StrictStr,
        calendar_id_id_delete_calendar_and_move_events_post_request: CalendarIdIdDeleteCalendarAndMoveEventsPostRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def calendar_id_id_delete_calendar_and_move_events_post_without_preload_content(
        self,
        id: StrictStr,
        calendar_id_id_delete_calendar_and_move_events_post_request: CalendarIdIdDeleteCalendarAndMoveEventsPostRequest,
        _request_timeout: Union[
    ...
    def _calendar_id_id_delete_calendar_and_move_events_post_serialize(
        self,
        id,
        calendar_id_id_delete_calendar_and_move_events_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if calendar_id_id_delete_calendar_and_move_events_post_request is not None:
            _body_params = calendar_id_id_delete_calendar_and_move_events_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/calendar/id/{id}/deleteCalendarAndMoveEvents',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def calendar_id_id_get(
        ...
        _param = self._calendar_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def calendar_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def calendar_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _calendar_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def calendar_id_id_importi_cal_post(
        self,
        id: StrictStr,
        ...
        _param = self._calendar_id_id_importi_cal_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def calendar_id_id_importi_cal_post_with_http_info(
        self,
        id: StrictStr,
        body: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        _request_timeout: Union[
    ...
    @validate_call
    def calendar_id_id_importi_cal_post_without_preload_content(
        self,
        id: StrictStr,
        body: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        _request_timeout: Union[
    ...
    def _calendar_id_id_importi_cal_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/calendar/id/{id}/importiCal',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def calendar_id_id_put(
        ...
        _param = self._calendar_id_id_put_serialize(
            id=id,
            calendar=calendar,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def calendar_id_id_put_with_http_info(
        self,
        id: StrictStr,
        calendar: Calendar,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def calendar_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        calendar: Calendar,
        dry_run: Optional[StrictBool] = None,
    ...
    def _calendar_id_id_put_serialize(
        self,
        id,
        calendar,
        dry_run,
    ...
    def calendar_post(
        ...
        _param = self._calendar_post_serialize(
            calendar=calendar,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def calendar_post_with_http_info(
        self,
        calendar: Calendar,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def calendar_post_without_preload_content(
        self,
        calendar: Calendar,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
