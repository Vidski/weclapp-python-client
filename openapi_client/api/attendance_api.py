...
class AttendanceApi:
    ...
    def attendance_count_get(
        ...
        _param = self._attendance_count_get_serialize(
    ...
    @validate_call
    def attendance_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def attendance_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _attendance_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/attendance/count',
    ...
    @validate_call
    def attendance_current_attendance_get(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._attendance_current_attendance_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AttendanceCurrentAttendanceGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def attendance_current_attendance_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AttendanceCurrentAttendanceGet200Response]:
        """attendance_current_attendance_get
    ...
    @validate_call
    def attendance_current_attendance_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _attendance_current_attendance_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/attendance/currentAttendance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def attendance_get(
        ...
        _param = self._attendance_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def attendance_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AttendanceGet200Response]:
        """query attendance
    ...
    @validate_call
    def attendance_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def attendance_id_id_delete(
        ...
        _param = self._attendance_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def attendance_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def attendance_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _attendance_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/attendance/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def attendance_id_id_get(
        ...
        _param = self._attendance_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def attendance_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def attendance_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _attendance_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def attendance_id_id_put(
        ...
        _param = self._attendance_id_id_put_serialize(
            id=id,
            attendance=attendance,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def attendance_id_id_put_with_http_info(
        self,
        id: StrictStr,
        attendance: Attendance,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def attendance_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        attendance: Attendance,
        dry_run: Optional[StrictBool] = None,
    ...
    def _attendance_id_id_put_serialize(
        self,
        id,
        attendance,
        dry_run,
    ...
    def attendance_log_off_post(
        ...
        _param = self._attendance_log_off_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def attendance_log_off_post_with_http_info(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def attendance_log_off_post_without_preload_content(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    def _attendance_log_off_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/attendance/logOff',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def attendance_log_on_post(
        ...
        _param = self._attendance_log_on_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def attendance_log_on_post_with_http_info(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def attendance_log_on_post_without_preload_content(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    def _attendance_log_on_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/attendance/logOn',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def attendance_post(
        ...
        _param = self._attendance_post_serialize(
            attendance=attendance,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def attendance_post_with_http_info(
        self,
        attendance: Attendance,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def attendance_post_without_preload_content(
        self,
        attendance: Attendance,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _attendance_post_serialize(
        self,
        attendance,
        dry_run,
        _request_auth,
