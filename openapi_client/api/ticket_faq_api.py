...
class TicketFaqApi:
    ...
    def ticket_faq_count_get(
        ...
        _param = self._ticket_faq_count_get_serialize(
    ...
    @validate_call
    def ticket_faq_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def ticket_faq_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _ticket_faq_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def ticket_faq_get(
        ...
        _param = self._ticket_faq_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def ticket_faq_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TicketFaqGet200Response]:
        """query ticketFaq
    ...
    @validate_call
    def ticket_faq_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def ticket_faq_id_id_delete(
        ...
        _param = self._ticket_faq_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def ticket_faq_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def ticket_faq_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _ticket_faq_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def ticket_faq_id_id_get(
        ...
        _param = self._ticket_faq_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def ticket_faq_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def ticket_faq_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _ticket_faq_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def ticket_faq_id_id_put(
        ...
        :param id: (required)
        :type id: str
        :param ticket_faq: (required)
        :type ticket_faq: TicketFaq
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._ticket_faq_id_id_put_serialize(
            id=id,
            ticket_faq=ticket_faq,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def ticket_faq_id_id_put_with_http_info(
        self,
        id: StrictStr,
        ticket_faq: TicketFaq,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def ticket_faq_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        ticket_faq: TicketFaq,
        dry_run: Optional[StrictBool] = None,
    ...
    def _ticket_faq_id_id_put_serialize(
        self,
        id,
        ticket_faq,
        dry_run,
        ...
        # process the form parameters
        # process the body parameter
        if ticket_faq is not None:
            _body_params = ticket_faq
    ...
    def ticket_faq_post(
        ...
        _param = self._ticket_faq_post_serialize(
            ticket_faq=ticket_faq,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def ticket_faq_post_with_http_info(
        self,
        ticket_faq: TicketFaq,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def ticket_faq_post_without_preload_content(
        self,
        ticket_faq: TicketFaq,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _ticket_faq_post_serialize(
        self,
        ticket_faq,
        dry_run,
        _request_auth,
