...
class PropertyTranslationApi:
    ...
    @validate_call
    def property_translation_read_property_translations_get(
        self,
        entity_name: StrictStr,
        entity_id: StrictStr,
        locale: Optional[StrictStr] = None,
        property_names: Optional[List[StrictStr]] = None,
        ...
        _param = self._property_translation_read_property_translations_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PropertyTranslationReadPropertyTranslationsGet200Response",
        }
    ...
    @validate_call
    def property_translation_read_property_translations_get_with_http_info(
        self,
        entity_name: StrictStr,
        entity_id: StrictStr,
        locale: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PropertyTranslationReadPropertyTranslationsGet200Response]:
        """property_translation_read_property_translations_get
    ...
    @validate_call
    def property_translation_read_property_translations_get_without_preload_content(
        self,
        entity_name: StrictStr,
        entity_id: StrictStr,
        locale: Optional[StrictStr] = None,
    ...
    def _property_translation_read_property_translations_get_serialize(
        self,
        entity_name,
        entity_id,
        locale,
        ...
        if property_names is not None:
            ...
            _query_params.append(('propertyNames', property_names))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/propertyTranslation/readPropertyTranslations',
    ...
    @validate_call
    def property_translation_update_property_translations_post(
        self,
        property_translation_update_property_translations_post_request: PropertyTranslationUpdatePropertyTranslationsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param property_translation_update_property_translations_post_request: (required)
        :type property_translation_update_property_translations_post_request: PropertyTranslationUpdatePropertyTranslationsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._property_translation_update_property_translations_post_serialize(
            property_translation_update_property_translations_post_request=property_translation_update_property_translations_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def property_translation_update_property_translations_post_with_http_info(
        self,
        property_translation_update_property_translations_post_request: PropertyTranslationUpdatePropertyTranslationsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def property_translation_update_property_translations_post_without_preload_content(
        self,
        property_translation_update_property_translations_post_request: PropertyTranslationUpdatePropertyTranslationsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _property_translation_update_property_translations_post_serialize(
        self,
        property_translation_update_property_translations_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if property_translation_update_property_translations_post_request is not None:
            _body_params = property_translation_update_property_translations_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/propertyTranslation/updatePropertyTranslations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
