...
class SerialNumberApi:
    ...
    def serial_number_count_get(
        ...
        _param = self._serial_number_count_get_serialize(
    ...
    @validate_call
    def serial_number_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def serial_number_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _serial_number_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/serialNumber/count',
    ...
    def serial_number_get(
        ...
        _param = self._serial_number_get_serialize(
            page=page,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SerialNumberGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def serial_number_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SerialNumberGet200Response]:
        """query serialNumber
    ...
    @validate_call
    def serial_number_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _serial_number_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
    ...
    def serial_number_id_id_get(
        ...
        _param = self._serial_number_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def serial_number_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def serial_number_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _serial_number_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/serialNumber/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def serial_number_id_id_put(
        ...
        :type serial_number: SerialNumber
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._serial_number_id_id_put_serialize(
            id=id,
    ...
    @validate_call
    def serial_number_id_id_put_with_http_info(
        self,
        id: StrictStr,
        serial_number: SerialNumber,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def serial_number_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        serial_number: SerialNumber,
        dry_run: Optional[StrictBool] = None,
    ...
    def _serial_number_id_id_put_serialize(
        self,
        id,
        serial_number,
        dry_run,
