...
class ContactApi:
    ...
    def contact_count_get(
        ...
        """ # noqa: E501
        warnings.warn("GET /contact/count is deprecated.", DeprecationWarning)

        _param = self._contact_count_get_serialize(
    ...
    @validate_call
    def contact_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def contact_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _contact_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def contact_get(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /contact is deprecated.", DeprecationWarning)
    ...
    def contact_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContactGet200Response]:
        """(Deprecated) query contact
    ...
    def contact_id_id_delete(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("DELETE /contact/id/{id} is deprecated.", DeprecationWarning)

        _param = self._contact_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def contact_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def contact_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _contact_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    @validate_call
    def contact_id_id_download_image_get(
        self,
        id: StrictStr,
        ...
        """(Deprecated) contact_id_id_download_image_get
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /contact/id/{id}/downloadImage is deprecated.", DeprecationWarning)

        _param = self._contact_id_id_download_image_get_serialize(
            id=id,
    ...
    @validate_call
    def contact_id_id_download_image_get_with_http_info(
        self,
        id: StrictStr,
        scale_width: Optional[StrictInt] = None,
        scale_height: Optional[StrictInt] = None,
    ...
    @validate_call
    def contact_id_id_download_image_get_without_preload_content(
        self,
        id: StrictStr,
        scale_width: Optional[StrictInt] = None,
        scale_height: Optional[StrictInt] = None,
    ...
    def _contact_id_id_download_image_get_serialize(
        self,
        id,
        scale_width,
        scale_height,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/contact/id/{id}/downloadImage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def contact_id_id_get(
        ...
        """(Deprecated) query a specific contact
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /contact/id/{id} is deprecated.", DeprecationWarning)

        _param = self._contact_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def contact_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def contact_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _contact_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def contact_id_id_put(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PUT /contact/id/{id} is deprecated.", DeprecationWarning)

        _param = self._contact_id_id_put_serialize(
            id=id,
            contact=contact,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def contact_id_id_put_with_http_info(
        self,
        id: StrictStr,
        contact: Contact,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def contact_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        contact: Contact,
        dry_run: Optional[StrictBool] = None,
    ...
    def _contact_id_id_put_serialize(
        self,
        id,
        contact,
        dry_run,
    ...
    @validate_call
    def contact_id_id_upload_image_post(
        self,
        id: StrictStr,
        ...
        """(Deprecated) contact_id_id_upload_image_post
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /contact/id/{id}/uploadImage is deprecated.", DeprecationWarning)

        _param = self._contact_id_id_upload_image_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def contact_id_id_upload_image_post_with_http_info(
        self,
        id: StrictStr,
        body: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        _request_timeout: Union[
    ...
    @validate_call
    def contact_id_id_upload_image_post_without_preload_content(
        self,
        id: StrictStr,
        body: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        _request_timeout: Union[
    ...
    def _contact_id_id_upload_image_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/contact/id/{id}/uploadImage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def contact_post(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /contact is deprecated.", DeprecationWarning)
