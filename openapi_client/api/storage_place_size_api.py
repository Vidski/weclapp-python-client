...
class StoragePlaceSizeApi:
    ...
    @validate_call
    def storage_place_size_count_get(
        self,
        ...
        _param = self._storage_place_size_count_get_serialize(
    ...
    @validate_call
    def storage_place_size_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def storage_place_size_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _storage_place_size_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/storagePlaceSize/count',
    ...
    def storage_place_size_get(
        ...
        _param = self._storage_place_size_get_serialize(
            page=page,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "StoragePlaceSizeGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def storage_place_size_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StoragePlaceSizeGet200Response]:
        """query storagePlaceSize
    ...
    @validate_call
    def storage_place_size_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _storage_place_size_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/storagePlaceSize',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def storage_place_size_id_id_delete(
        self,
        id: StrictStr,
        ...
        _param = self._storage_place_size_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def storage_place_size_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def storage_place_size_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _storage_place_size_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/storagePlaceSize/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def storage_place_size_id_id_get(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._storage_place_size_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def storage_place_size_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def storage_place_size_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _storage_place_size_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def storage_place_size_id_id_put(
        self,
        id: StrictStr,
        ...
        :param id: (required)
        :type id: str
        :param storage_place_size: (required)
        :type storage_place_size: StoragePlaceSize
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._storage_place_size_id_id_put_serialize(
            id=id,
            storage_place_size=storage_place_size,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def storage_place_size_id_id_put_with_http_info(
        self,
        id: StrictStr,
        storage_place_size: StoragePlaceSize,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def storage_place_size_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        storage_place_size: StoragePlaceSize,
        dry_run: Optional[StrictBool] = None,
    ...
    def _storage_place_size_id_id_put_serialize(
        self,
        id,
        storage_place_size,
        dry_run,
        ...
        # process the form parameters
        # process the body parameter
        if storage_place_size is not None:
            _body_params = storage_place_size
    ...
    def storage_place_size_post(
        ...
        _param = self._storage_place_size_post_serialize(
            storage_place_size=storage_place_size,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def storage_place_size_post_with_http_info(
        self,
        storage_place_size: StoragePlaceSize,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def storage_place_size_post_without_preload_content(
        self,
        storage_place_size: StoragePlaceSize,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _storage_place_size_post_serialize(
        self,
        storage_place_size,
        dry_run,
        _request_auth,
