...
class RemotePrintJobApi:
    ...
    @validate_call
    def remote_print_job_count_get(
        self,
        ...
        _param = self._remote_print_job_count_get_serialize(
    ...
    @validate_call
    def remote_print_job_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def remote_print_job_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _remote_print_job_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/remotePrintJob/count',
    ...
    @validate_call
    def remote_print_job_create_print_job_with_document_post(
        self,
        weclapp_os_id: StrictStr,
        ...
        :param weclapp_os_id: (required)
        :type weclapp_os_id: str
        :param printer_name: (required)
        ...
        _param = self._remote_print_job_create_print_job_with_document_post_serialize(
            weclapp_os_id=weclapp_os_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RemotePrintJobCreatePrintJobWithDocumentPost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def remote_print_job_create_print_job_with_document_post_with_http_info(
        self,
        weclapp_os_id: StrictStr,
        printer_name: StrictStr,
        quantity: StrictInt,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RemotePrintJobCreatePrintJobWithDocumentPost200Response]:
        """remote_print_job_create_print_job_with_document_post
    ...
    @validate_call
    def remote_print_job_create_print_job_with_document_post_without_preload_content(
        self,
        weclapp_os_id: StrictStr,
        printer_name: StrictStr,
        quantity: StrictInt,
    ...
    def _remote_print_job_create_print_job_with_document_post_serialize(
        self,
        weclapp_os_id,
        printer_name,
        quantity,
        ...
        # process the path parameters
        # process the query parameters
        if weclapp_os_id is not None:
            
            _query_params.append(('weclappOsId', weclapp_os_id))
            
        if printer_name is not None:
            
            _query_params.append(('printerName', printer_name))
        ...
        if document_description is not None:
            ...
            _query_params.append(('documentDescription', document_description))
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/remotePrintJob/createPrintJobWithDocument',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remote_print_job_get(
        ...
        _param = self._remote_print_job_get_serialize(
            page=page,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RemotePrintJobGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def remote_print_job_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RemotePrintJobGet200Response]:
        """query remotePrintJob
    ...
    @validate_call
    def remote_print_job_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _remote_print_job_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
    ...
    @validate_call
    def remote_print_job_id_id_delete(
        self,
        id: StrictStr,
        ...
        _param = self._remote_print_job_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def remote_print_job_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def remote_print_job_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _remote_print_job_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/remotePrintJob/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def remote_print_job_id_id_get(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._remote_print_job_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def remote_print_job_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def remote_print_job_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _remote_print_job_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def remote_print_job_id_id_put(
        self,
        id: StrictStr,
        ...
        :param id: (required)
        :type id: str
        :param remote_print_job: (required)
        :type remote_print_job: RemotePrintJob
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._remote_print_job_id_id_put_serialize(
            id=id,
            remote_print_job=remote_print_job,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def remote_print_job_id_id_put_with_http_info(
        self,
        id: StrictStr,
        remote_print_job: RemotePrintJob,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def remote_print_job_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        remote_print_job: RemotePrintJob,
        dry_run: Optional[StrictBool] = None,
    ...
    def _remote_print_job_id_id_put_serialize(
        self,
        id,
        remote_print_job,
        dry_run,
        ...
        # process the form parameters
        # process the body parameter
        if remote_print_job is not None:
            _body_params = remote_print_job
    ...
    def remote_print_job_post(
        ...
        _param = self._remote_print_job_post_serialize(
            remote_print_job=remote_print_job,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def remote_print_job_post_with_http_info(
        self,
        remote_print_job: RemotePrintJob,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def remote_print_job_post_without_preload_content(
        self,
        remote_print_job: RemotePrintJob,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _remote_print_job_post_serialize(
        self,
        remote_print_job,
        dry_run,
        _request_auth,
