...
class DocumentApi:
    ...
    @validate_call
    def document_copy_post(
        self,
        document_copy_post_request: DocumentCopyPostRequest,
        ...
        :param document_copy_post_request: (required)
        :type document_copy_post_request: DocumentCopyPostRequest
        ...
        _param = self._document_copy_post_serialize(
            document_copy_post_request=document_copy_post_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DocumentCopyPost200Response",
        }
    ...
    @validate_call
    def document_copy_post_with_http_info(
        self,
        document_copy_post_request: DocumentCopyPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DocumentCopyPost200Response]:
        """document_copy_post
    ...
    @validate_call
    def document_copy_post_without_preload_content(
        self,
        document_copy_post_request: DocumentCopyPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _document_copy_post_serialize(
        self,
        document_copy_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if document_copy_post_request is not None:
            _body_params = document_copy_post_request
    ...
    def document_count_get(
        ...
        _param = self._document_count_get_serialize(
            entity_id=entity_id,
    ...
    @validate_call
    def document_count_get_with_http_info(
        self,
        entity_id: StrictStr,
        entity_name: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def document_count_get_without_preload_content(
        self,
        entity_id: StrictStr,
        entity_name: StrictStr,
        _request_timeout: Union[
    ...
    def _document_count_get_serialize(
        self,
        entity_id,
        entity_name,
        _request_auth,
    ...
    @validate_call
    def document_id_id_copy_post(
        self,
        id: StrictStr,
        document_id_id_copy_post_request: DocumentIdIdCopyPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: str
        :param document_id_id_copy_post_request: (required)
        :type document_id_id_copy_post_request: DocumentIdIdCopyPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._document_id_id_copy_post_serialize(
            id=id,
            document_id_id_copy_post_request=document_id_id_copy_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def document_id_id_copy_post_with_http_info(
        self,
        id: StrictStr,
        document_id_id_copy_post_request: DocumentIdIdCopyPostRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def document_id_id_copy_post_without_preload_content(
        self,
        id: StrictStr,
        document_id_id_copy_post_request: DocumentIdIdCopyPostRequest,
        _request_timeout: Union[
    ...
    def _document_id_id_copy_post_serialize(
        self,
        id,
        document_id_id_copy_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if document_id_id_copy_post_request is not None:
            _body_params = document_id_id_copy_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/document/id/{id}/copy',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def document_id_id_delete(
        ...
        _param = self._document_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def document_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def document_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _document_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    @validate_call
    def document_id_id_download_document_version_get(
        self,
        id: StrictStr,
        id2: StrictStr,
        _request_timeout: Union[
        ...
        _param = self._document_id_id_download_document_version_get_serialize(
            id=id,
            id2=id2,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def document_id_id_download_document_version_get_with_http_info(
        self,
        id: StrictStr,
        id2: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def document_id_id_download_document_version_get_without_preload_content(
        self,
        id: StrictStr,
        id2: StrictStr,
        _request_timeout: Union[
    ...
    def _document_id_id_download_document_version_get_serialize(
        self,
        id,
        id2,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/document/id/{id}/downloadDocumentVersion',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def document_id_id_download_document_versions_zipped_get(
        self,
        id: StrictStr,
        ...
        _param = self._document_id_id_download_document_versions_zipped_get_serialize(
            id=id,
            filename=filename,
            ids=ids,
            _request_auth=_request_auth,
    ...
    @validate_call
    def document_id_id_download_document_versions_zipped_get_with_http_info(
        self,
        id: StrictStr,
        filename: Optional[StrictStr] = None,
        ids: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def document_id_id_download_document_versions_zipped_get_without_preload_content(
        self,
        id: StrictStr,
        filename: Optional[StrictStr] = None,
        ids: Optional[List[StrictStr]] = None,
    ...
    def _document_id_id_download_document_versions_zipped_get_serialize(
        self,
        id,
        filename,
        ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/document/id/{id}/downloadDocumentVersionsZipped',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def document_id_id_download_get(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._document_id_id_download_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def document_id_id_download_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def document_id_id_download_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _document_id_id_download_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/document/id/{id}/download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def document_id_id_get(
        ...
        _param = self._document_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def document_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def document_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _document_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def document_id_id_put(
        ...
        _param = self._document_id_id_put_serialize(
            id=id,
            document=document,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def document_id_id_put_with_http_info(
        self,
        id: StrictStr,
        document: Document,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def document_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        document: Document,
        dry_run: Optional[StrictBool] = None,
    ...
    def _document_id_id_put_serialize(
        self,
        id,
        document,
        dry_run,
    ...
    @validate_call
    def document_id_id_upload_post(
        self,
        id: StrictStr,
        ...
        _param = self._document_id_id_upload_post_serialize(
            id=id,
            body=body,
            comment=comment,
            _request_auth=_request_auth,
    ...
    @validate_call
    def document_id_id_upload_post_with_http_info(
        self,
        id: StrictStr,
        body: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        comment: Optional[StrictStr] = None,
    ...
    @validate_call
    def document_id_id_upload_post_without_preload_content(
        self,
        id: StrictStr,
        body: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        comment: Optional[StrictStr] = None,
    ...
    def _document_id_id_upload_post_serialize(
        self,
        id,
        body,
        comment,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/document/id/{id}/upload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def document_upload_post(
        ...
        _param = self._document_upload_post_serialize(
            entity_name=entity_name,
            entity_id=entity_id,
            name=name,
            body=body,
    ...
    @validate_call
    def document_upload_post_with_http_info(
        self,
        entity_name: StrictStr,
        entity_id: StrictStr,
        name: StrictStr,
    ...
    @validate_call
    def document_upload_post_without_preload_content(
        self,
        entity_name: StrictStr,
        entity_id: StrictStr,
        name: StrictStr,
    ...
    def _document_upload_post_serialize(
        self,
        entity_name,
        entity_id,
        name,
