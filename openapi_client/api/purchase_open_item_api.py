...
class PurchaseOpenItemApi:
    ...
    @validate_call
    def purchase_open_item_count_get(
        self,
        ...
        _param = self._purchase_open_item_count_get_serialize(
    ...
    @validate_call
    def purchase_open_item_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def purchase_open_item_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _purchase_open_item_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/purchaseOpenItem/count',
    ...
    def purchase_open_item_get(
        ...
        _param = self._purchase_open_item_get_serialize(
            page=page,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PurchaseOpenItemGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def purchase_open_item_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PurchaseOpenItemGet200Response]:
        """query purchaseOpenItem
    ...
    @validate_call
    def purchase_open_item_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _purchase_open_item_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/purchaseOpenItem',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def purchase_open_item_id_id_create_payment_application_post(
        self,
        id: StrictStr,
        purchase_open_item_id_id_create_payment_application_post_request: PurchaseOpenItemIdIdCreatePaymentApplicationPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: str
        :param purchase_open_item_id_id_create_payment_application_post_request: (required)
        :type purchase_open_item_id_id_create_payment_application_post_request: PurchaseOpenItemIdIdCreatePaymentApplicationPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._purchase_open_item_id_id_create_payment_application_post_serialize(
            id=id,
            purchase_open_item_id_id_create_payment_application_post_request=purchase_open_item_id_id_create_payment_application_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PurchaseOpenItemIdIdCreatePaymentApplicationPost200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def purchase_open_item_id_id_create_payment_application_post_with_http_info(
        self,
        id: StrictStr,
        purchase_open_item_id_id_create_payment_application_post_request: PurchaseOpenItemIdIdCreatePaymentApplicationPostRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PurchaseOpenItemIdIdCreatePaymentApplicationPost200Response]:
        """purchase_open_item_id_id_create_payment_application_post
    ...
    @validate_call
    def purchase_open_item_id_id_create_payment_application_post_without_preload_content(
        self,
        id: StrictStr,
        purchase_open_item_id_id_create_payment_application_post_request: PurchaseOpenItemIdIdCreatePaymentApplicationPostRequest,
        _request_timeout: Union[
    ...
    def _purchase_open_item_id_id_create_payment_application_post_serialize(
        self,
        id,
        purchase_open_item_id_id_create_payment_application_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if purchase_open_item_id_id_create_payment_application_post_request is not None:
            _body_params = purchase_open_item_id_id_create_payment_application_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/purchaseOpenItem/id/{id}/createPaymentApplication',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def purchase_open_item_id_id_get(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._purchase_open_item_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def purchase_open_item_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def purchase_open_item_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _purchase_open_item_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/purchaseOpenItem/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
