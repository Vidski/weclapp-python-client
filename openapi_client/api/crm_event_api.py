...
class CrmEventApi:
    ...
    def crm_event_count_get(
        ...
        _param = self._crm_event_count_get_serialize(
    ...
    @validate_call
    def crm_event_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def crm_event_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _crm_event_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def crm_event_get(
        ...
        _param = self._crm_event_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def crm_event_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CrmEventGet200Response]:
        """query crmEvent
    ...
    @validate_call
    def crm_event_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def crm_event_id_id_delete(
        ...
        _param = self._crm_event_id_id_delete_serialize(
            id=id,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def crm_event_id_id_delete_with_http_info(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def crm_event_id_id_delete_without_preload_content(
        self,
        id: StrictStr,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _crm_event_id_id_delete_serialize(
        self,
        id,
        dry_run,
        _request_auth,
    ...
    def crm_event_id_id_get(
        ...
        _param = self._crm_event_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def crm_event_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def crm_event_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _crm_event_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def crm_event_id_id_put(
        ...
        :param id: (required)
        :type id: str
        :param crm_event: (required)
        :type crm_event: CrmEvent
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._crm_event_id_id_put_serialize(
            id=id,
            crm_event=crm_event,
            dry_run=dry_run,
            _request_auth=_request_auth,
    ...
    @validate_call
    def crm_event_id_id_put_with_http_info(
        self,
        id: StrictStr,
        crm_event: CrmEvent,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def crm_event_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        crm_event: CrmEvent,
        dry_run: Optional[StrictBool] = None,
    ...
    def _crm_event_id_id_put_serialize(
        self,
        id,
        crm_event,
        dry_run,
        ...
        # process the form parameters
        # process the body parameter
        if crm_event is not None:
            _body_params = crm_event
    ...
    def crm_event_post(
        ...
        _param = self._crm_event_post_serialize(
            crm_event=crm_event,
            dry_run=dry_run,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def crm_event_post_with_http_info(
        self,
        crm_event: CrmEvent,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def crm_event_post_without_preload_content(
        self,
        crm_event: CrmEvent,
        dry_run: Optional[StrictBool] = None,
        _request_timeout: Union[
