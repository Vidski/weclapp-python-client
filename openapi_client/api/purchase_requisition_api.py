...
class PurchaseRequisitionApi:
    ...
    @validate_call
    def purchase_requisition_count_get(
        self,
        ...
        _param = self._purchase_requisition_count_get_serialize(
    ...
    @validate_call
    def purchase_requisition_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def purchase_requisition_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _purchase_requisition_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/purchaseRequisition/count',
    ...
    @validate_call
    def purchase_requisition_delete_all_requisitions_post(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
        ...
        _param = self._purchase_requisition_delete_all_requisitions_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def purchase_requisition_delete_all_requisitions_post_with_http_info(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def purchase_requisition_delete_all_requisitions_post_without_preload_content(
        self,
        body: Dict[str, Any],
        _request_timeout: Union[
            None,
    ...
    def _purchase_requisition_delete_all_requisitions_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/purchaseRequisition/deleteAllRequisitions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def purchase_requisition_get(
        ...
        _param = self._purchase_requisition_get_serialize(
            page=page,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PurchaseRequisitionGet200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def purchase_requisition_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PurchaseRequisitionGet200Response]:
        """query purchaseRequisition
    ...
    @validate_call
    def purchase_requisition_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def _purchase_requisition_get_serialize(
        self,
        page,
        page_size,
        serialize_nulls,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/purchaseRequisition',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def purchase_requisition_id_id_get(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._purchase_requisition_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def purchase_requisition_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def purchase_requisition_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _purchase_requisition_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/purchaseRequisition/id/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def purchase_requisition_id_id_put(
        self,
        id: StrictStr,
        ...
        :param id: (required)
        :type id: str
        :param purchase_requisition: (required)
        :type purchase_requisition: PurchaseRequisition
        :param dry_run:
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._purchase_requisition_id_id_put_serialize(
            id=id,
    ...
    @validate_call
    def purchase_requisition_id_id_put_with_http_info(
        self,
        id: StrictStr,
        purchase_requisition: PurchaseRequisition,
        dry_run: Optional[StrictBool] = None,
    ...
    @validate_call
    def purchase_requisition_id_id_put_without_preload_content(
        self,
        id: StrictStr,
        purchase_requisition: PurchaseRequisition,
        dry_run: Optional[StrictBool] = None,
    ...
    def _purchase_requisition_id_id_put_serialize(
        self,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if purchase_requisition is not None:
            _body_params = purchase_requisition
    ...
    @validate_call
    def purchase_requisition_start_material_planning_run_post(
        self,
        purchase_requisition_start_material_planning_run_post_request: PurchaseRequisitionStartMaterialPlanningRunPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param purchase_requisition_start_material_planning_run_post_request: (required)
        :type purchase_requisition_start_material_planning_run_post_request: PurchaseRequisitionStartMaterialPlanningRunPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._purchase_requisition_start_material_planning_run_post_serialize(
            purchase_requisition_start_material_planning_run_post_request=purchase_requisition_start_material_planning_run_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def purchase_requisition_start_material_planning_run_post_with_http_info(
        self,
        purchase_requisition_start_material_planning_run_post_request: PurchaseRequisitionStartMaterialPlanningRunPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JobAbortGet200Response]:
        """purchase_requisition_start_material_planning_run_post
    ...
    @validate_call
    def purchase_requisition_start_material_planning_run_post_without_preload_content(
        self,
        purchase_requisition_start_material_planning_run_post_request: PurchaseRequisitionStartMaterialPlanningRunPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _purchase_requisition_start_material_planning_run_post_serialize(
        self,
        purchase_requisition_start_material_planning_run_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if purchase_requisition_start_material_planning_run_post_request is not None:
            _body_params = purchase_requisition_start_material_planning_run_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/purchaseRequisition/startMaterialPlanningRun',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
