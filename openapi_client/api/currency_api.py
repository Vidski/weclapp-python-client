...
class CurrencyApi:
    ...
    @validate_call
    def currency_company_currency_get(
        self,
        ...
        _param = self._currency_company_currency_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CurrencyCompanyCurrencyGet200Response",
        }
    ...
    @validate_call
    def currency_company_currency_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CurrencyCompanyCurrencyGet200Response]:
        """currency_company_currency_get
    ...
    @validate_call
    def currency_company_currency_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _currency_company_currency_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/currency/companyCurrency',
    ...
    def currency_count_get(
        ...
        _param = self._currency_count_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def currency_count_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def currency_count_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _currency_count_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def currency_get(
        ...
        _param = self._currency_get_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    def currency_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CurrencyGet200Response]:
        """query currency
    ...
    @validate_call
    def currency_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        serialize_nulls: Optional[StrictBool] = None,
    ...
    def currency_id_id_get(
        ...
        _param = self._currency_id_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def currency_id_id_get_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def currency_id_id_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _currency_id_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
